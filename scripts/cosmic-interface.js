...
const supportersCardMarkup=item=>`<button class="cosmic-card supporters-card" type="button" data-cosmic-card data-key="${item.id}" aria-label="${item.title}を開く"><span class="cosmic-card__stack" data-cosmic-card-stack><span class="cosmic-card__ghost" aria-hidden="true"></span><span class="cosmic-card__glass"><span class="supporters-card__decor" aria-hidden="true"></span><span class="supporters-card__content"><span class="supporters-card__title">${item.title}</span><span class="supporters-card__description"><span class="supporters-card__description-line">${item.lead}</span><span class="supporters-card__description-line">${item.body}</span></span></span><span class="cosmic-card__edge" aria-hidden="true"></span><span class="cosmic-card__flare" aria-hidden="true"></span></span></span></button>`;
